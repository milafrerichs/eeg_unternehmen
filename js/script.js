(function() {
  ...
  gesamt = function() {
    ...
    return d3.csv("/eeg_unternehmen/gesamt.csv", function(error, data) {
      ...
      svg.append("g").attr("class", "y axis").attr("transform", "translate(-15,0)").call(yAxis).append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end").text("Anzahl Unternehmen").attr("class","anzahl");
      svg.append("g").attr("class", "y axis ").attr("transform", "translate(" + (width + 15) + ",0)").call(y2Axis).append("text").attr("transform", "rotate(-90)").attr("y", -16).attr("dy", ".71em").style("text-anchor", "end").text("Verbrauch in GwH").attr("class","verbrauch");
  ...
  top_20_unternehmen = function() {
    ...
    table = d3.select("#top_20").append("table").attr("class","table-striped table-bordered");
