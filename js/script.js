(function() {
  ...
  bundesland_branchen = function(branche) {
    ...
    pb_height = 200;
    pb_padding = 50;
    return d3.csv("/eeg/branche_bundesland.csv", function(error, data) {
  ...
  per_bundesland = function() {
    ...
    pb_padding = 50;
    bar_padding = 10;
    svg = d3.select("body").append("svg").attr("id", "per_bundesland").attr("width", pb_width + pb_padding * 2 + 50).attr("height", pb_height + pb_padding * 2 + 90);
  ...
  $(function() {
    d3.csv("/eeg/per_bundesland.csv", function(error, data) {
      var entry;
